...
function myFunction() {
  ...
  if(myVarFromPhp==''){
window.location.replace("http://139.59.38.160/Fruit/Dashboard/page-login.php");
  }else{
     if(error!=''){
      if(error==1){
                    ...
                    <h3 class="menu-title">Seetings</h3>
                     <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                           ...
                           <li><i class="menu-icon fa fa-pencil-square-o"></i><a href="AddImages.php"> FruitExpress Images</a></li>    
                        </ul>
                    </li>
