package com.liteafrica.fruitking.Activites.Main_Page;
...
import com.liteafrica.fruitking.Activites.Canteen.SelectePaymentOption;
...
import com.liteafrica.fruitking.Model.Promo;
...
import com.liteafrica.fruitking.Utils.Marker_custom_infowindow;
    ...
    private void updateLocationUI(Location location) {
        ...
        if(!first && googleMap!=null) {
            ...
            if (pref.getUniqueRide() != null) {
                ...
                mDatabase.child("Fruit").child(con).addValueEventListener(_firebaseLogs);
            }
...
// Start the autocomplete intent.
            ...
            case R.id._confirm_book:
                    if(pref.get_food_money()>pref.getMinimumOrder()) {
                        ...
                        Toast.makeText(getApplicationContext(),"Order value is less than minimum value of R "+String.valueOf(pref.getMinimumOrder()),Toast.LENGTH_SHORT).show();
                    }
                                                    ...
                                                    if (pars[1].contains("false")) {
                                                        ...
                                                        if (pref.getUniqueRide() != null) {
                                                            ...
                                                            if (OTP != null) {
                                                                ...
                                                                mDatabase = FirebaseDatabase.getInstance().getReference();
                                                                mDatabase.child("Fruit").child(con).child("con").setValue(pref.getCon());
                                                                mDatabase.child("Fruit").child(con).child("UserMobile").setValue(pref.getDriverPhone());
                                                                mDatabase.child("Fruit").child(con).child("OTP").setValue(OTP);
                                                                mDatabase.child("Fruit").child(con).child("From_Address").setValue(_address);
                                                                mDatabase.child("Fruit").child(con).child("Book_To_Latitude").setValue(pref.getDropLat());
                                                                mDatabase.child("Fruit").child(con).child("Book_To_Longitude").setValue(pref.getDropLong());
                                                                mDatabase.child("Fruit").child(con).child("Cost").setValue(_total);
                                                                mDatabase.child("Fruit").child(con).child("Order").setValue(commaSeparatedValues);
                                                                pref.setDelivery(1);
    ...
    protected void onStop() {
        ...
        if (pref.getUniqueRide() != null && _firebaseLogs!=null) {
            String[] pars = pref.getUniqueRide().split("\\.");
            con = TextUtils.join("", pars);
            mDatabase.child("Fruit").child(con).removeEventListener(_firebaseLogs);
        }
    }
    ...
    public void toggleBottomSheet() {
        ...
        if (get1&& !drawn1 ) {
            ...
            CustomNotification("Order status", "Your order has been accepted.");
        }
        ...
        if (get2&& !drawn2 ) {
            ...
            CustomNotification("Order status", "Your order has been confirmed.");
        }
        ...
        if (get3&& !drawn3 ) {
            ...
            CustomNotification("Order status", "Estimated delivery time updated." + _estimate.getText().toString());
        }
        if (get4&& !drawn4 ) {
            drawn4 = true;
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (pref.getUniqueRide() != null && googleMap!=null && !stoped) {
                ...
                if (count != 0) {
                    ...
                    else if (_ask.contains("1") && !get1) {
                        get1 = true;
                        toggleBottomSheet();

                    }
                    else if (_ask.contains("2")&& !get2) {
                        get2 = true;
                        toggleBottomSheet();

                    }
                    else if (_ask.contains("3")&& !get3) {
                        get3 = true;
                        toggleBottomSheet();
                        }
                    else if (_ask.contains("4")&& !get4) {
                        get4 = true;
                        toggleBottomSheet();
                    }
                    else if (_ask.contains("5")&& !get5) {
                        get5 = true;
                        toggleBottomSheet();
