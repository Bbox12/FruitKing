package com.liteafrica.fruitking.Activites;
...
import com.liteafrica.fruitking.Activites.Canteen.QR_Main;
...
import com.liteafrica.fruitking.ConnectionDetector;
import com.liteafrica.fruitking.PrefManager;
import com.liteafrica.fruitking.R;
import com.liteafrica.fruitking.delivery.DrivermapApp;
                            ...
                            public void onResponse(String response) {
                                ...
                                for (int i = 0; i < version.length(); i++) {
                                    ...
                                    if(pref.getResposibility()==2) {
                                         Book_Ride_Now = jsonObj.getJSONArray("Book_Ride_Now_driver");
                                    }else{
                                ...
                                if(Book_Ride_Now.length()!=0) {
                                    for (int i = 0; i < Book_Ride_Now.length(); i++) {
                                        ...
                                        if (!c.isNull("Unique_Ride_Code") && !c.getString("Unique_Ride_Code").contains("null") ) {
                                            ...
                                            pref.set_food_money(Float.parseFloat(c.getString("Cost")));
            ...
            if (_imp_1 != imp) {
                if (!Splash_screen.this.isFinishing()) {
                    new AlertDialog.Builder(Splash_screen.this, R.style.AlertDialogTheme)
                            ...
                            .setTitle("Update FruitKing")
                            .setMessage("A new version of FruitKing is available!")
                ...
                if (version_1 != version_) {
                    if (!Splash_screen.this.isFinishing()) {
                        new AlertDialog.Builder(Splash_screen.this, R.style.AlertDialogTheme)
                                .setTitle("Its time to update FruitKing")
                                .setMessage("A new version of FruitKing is available!")
                                .setPositiveButton("Update", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
    ...
    private void go_again() {
        ...
        if (pref.getResposibility()==1) {
            ...
            if(pref.getResposibility()==2) {
                ...
                Intent i = new Intent(Splash_screen.this, QR_Main.class);
                startActivity(i);
                finish();
